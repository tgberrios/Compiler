...
Opción 1: PostgreSQL → MSSQL
Más fácil porque ya tienes la lógica de PostgreSQL
Solo necesitas adaptar la salida a sintaxis MSSQL
Opción 2: MariaDB ↔ MSSQL
Más desafiante porque son motores diferentes
Pero más valioso para completar el framework
Opción 3: Completar todo el framework
Hacer las 3 direcciones que faltan
