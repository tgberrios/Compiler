...
(
    ...
    min_latency_ms         numeric(16, 2),
    avg_latency_ms         numeric(16, 2),
    max_latency_ms         numeric(16, 2),
    p95_latency_ms         numeric(16, 2),
    p99_latency_ms         numeric(16, 2),
...
comment on column metadata.transfer_metrics.min_latency_ms is 'Minimum latency in milliseconds';

comment on column metadata.transfer_metrics.avg_latency_ms is 'Average latency in milliseconds';

comment on column metadata.transfer_metrics.max_latency_ms is 'Maximum latency in milliseconds';

comment on column metadata.transfer_metrics.p95_latency_ms is '95th percentile latency in milliseconds';

comment on column metadata.transfer_metrics.p99_latency_ms is '99th percentile latency in milliseconds';

comment on column metadata.transfer_metrics.latency_samples is 'Number of samples used for latency calculations';
